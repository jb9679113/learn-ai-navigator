  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3 mb-3">
        ...
        <span className="text-lg">{sourceTypeIcons[resource.sourceType]}</span>
      </div>
      ...
      <div className="flex items-center justify-between">
        <span className={`px-2 py-0.5 text-xs font-medium rounded-full ${difficultyColors[resource.difficulty]}`}>
